        ...
        {categories.map((categorie, idx) => (
          ...
          >
            <div
              ...
              className={`relative z-20 flex h-10 w-10 transform items-center justify-center rounded-full transition-transform duration-300 [@media(max-width:1068px)]:z-0 ${categorie.id === active && "[@media(max-width:1068px)]:scale-x-[1.489] [@media(max-width:1068px)]:scale-y-[1.447]"}`}
            >
              <Image
                src={categorie.icon}
                width={24}
